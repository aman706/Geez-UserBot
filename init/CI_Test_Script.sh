...
tg_sendinfo "<code>I am gonna merge staging into Ironx-UserBot</code>"
cd
...
git push --force origin staging: Ironx-UserBot
tg_sendinfo "<code>I have merged all commits from staging intoIronx-UserBot</code>"
